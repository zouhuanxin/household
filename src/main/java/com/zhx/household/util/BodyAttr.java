...
//    }
    ...
    //sdk版
    public static String body_byte(String imgStr) {
        try {
            ...
            byte[] file = DatatypeConverter.parseBase64Binary(imgStr);
            JSONObject result = AuthService.beginAipBodyAnalysis().bodyAttr(file, options);
    ...
    public static String body_trafflc(String imagedata, String id, String area) throws JSONException, JSONException {
        ...
        // 参数为二进制数组
        byte[] file = DatatypeConverter.parseBase64Binary(imagedata);
